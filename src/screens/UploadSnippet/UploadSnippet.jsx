...
import styles from "./UploadSnippet.module.css";
    ...
    return (
        <div className={styles.mainCont}>
                ...
                <div className={styles.list_view}>
                    {
                        loading ?
                            [1, 2, 3, 4]?.map((item, index) => (
                                <Skeleton.Button active={true} className={styles.skeleton} style={{ width: 510, height: 170, marginTop: 20, borderRadius: 10 }} />
            ...
            <RightModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                ...
                title="Upload" onClick={onUploadSnippet}  btnClass={styles.uploadBtn} />
